...
public class Constants {
	...
	public static final String OLD_MD5 = "7dc46bd75c1042f943942a37d646afaa";

	//WeiboV5.6.apk 正确的MD5值
	public static final String NEW_MD5 = "c2da8edf4b796c1a393be38730ac93fe";

	//用于测试的packageName
	public static final String TEST_PACKAGENAME = "com.szwyx.rxb";

	public static final String PATH = Environment.getExternalStorageDirectory() + File.separator;

	//合成得到的新版apk
	public static final String NEW_APK_PATH = PATH + "NewRenXingBao.apk";
